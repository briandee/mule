...
import static org.mule.runtime.core.util.StringMessageUtils.headersToString;
...
/**
 * Builds implementations of {@link MuleMessage}.
 */
public class DefaultMuleMessageBuilder implements MuleMessage.Builder, MuleMessage.PayloadBuilder, MuleMessage.CollectionBuilder
{
     ...
     */
    public static class MuleMessageImplementation implements MuleMessage
    {
        ...
        private MuleMessageImplementation(String id, String rootId, TypedValue typedValue, Serializable attributes,
        ...
        public String toString()
        {
            ...
            buf.append(LINE_SEPARATOR);
            buf.append("  correlationId=").append(defaultString(getCorrelationId(), NOT_SET));
            buf.append(LINE_SEPARATOR);
            ...
            buf.append(LINE_SEPARATOR);
            buf.append(headersToString(this));
        ...
        private Map<String, DataHandler> deserializeAttachments(Map<String, SerializedDataHandler> attachments)
        {
